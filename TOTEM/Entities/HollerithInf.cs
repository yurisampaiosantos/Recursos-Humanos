...
namespace Entities
{
    ...
    public class HollerithInf
    {
        ...
        /// <summary>
        /// Construtor padrão para criação de um objeto hollerith (informe de rendimento).
        ...
        public HollerithInf(int id, string cod_sap, string month, string year, string type, string path)
        {
            this.Id = id;
