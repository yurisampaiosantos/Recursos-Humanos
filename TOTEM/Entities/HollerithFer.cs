...
{
    /// <summary>
    /// Classe responsável pelo modelo da entidade hollerith (férias).   
    /// Modelo baseado na tabela DM_FILES SCHEMA HUMANRESOURCES.
    /// </summary>
    public class HollerithFer
    {
        public HollerithFer() { }
        ...
        /// <summary>
        /// Construtor padrão para criação de um objeto hollerith (férias).
        /// Modelo baseado na tabela DM_FILES SCHEMA HUMANRESOURCES.
        /// </summary>
        ...
        public HollerithFer(int id, string cod_sap, string month, string year, string type, string path)
        {
            this.Id = id;
